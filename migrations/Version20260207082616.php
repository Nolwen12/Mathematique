 ...
 */
final class Version20260207082616 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie ADD CONSTRAINT `FK_497DD6347ECF78B0` FOREIGN KEY (cours_id) REFERENCES cours (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE niveau ADD CONSTRAINT `FK_4BDFF36BB3E9C81` FOREIGN KEY (niveau_id) REFERENCES cours (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
